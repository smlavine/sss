static inline void
matrixTranslation(float matrix[4][4], float x, float y, float z)
{
    matrix[0][0] = 1;
    matrix[1][0] = 0;
    matrix[2][0] = 0;
...
static inline void
matrixScale(float matrix[4][4], float x, float y, float z)
{
    matrix[0][0] = x;
    matrix[1][0] = 0;
    matrix[2][0] = 0;
...
static inline void
matrixRotationZ(float matrix[4][4], float angle)
{
    float s = sinf(angle);
    float c = cosf(angle);
...
static inline void
matrixProduct(float ab[4][4], const float a[4][4], const float b[4][4])
{
...
static inline void
matrixVectorProduct(float v[4], const float m[4][4], const float x[4])
{
